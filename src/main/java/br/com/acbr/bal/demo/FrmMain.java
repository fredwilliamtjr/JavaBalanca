package br.com.acbr.bal.demo;

import br.com.acbr.ACBrSessao;
import br.com.acbr.NivelLog;
import br.com.acbr.bal.ACBrBAL;
import br.com.acbr.bal.BALModelo;
...
public class FrmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbPorta.setModel(new DefaultComboBoxModel<>(new String[] { "COM1", "COM2", "LPT1", "LPT2", "\\\\localhost\\Epson", "c:\\temp\\ecf.txt", "TCP:192.168.0.31:9100" }));

        jLabel2.setText("Porta");

        cmbBaud.setModel(new DefaultComboBoxModel<>(new String[] { "110", "300", "600", "1200", "2400", "4800", "9600", "14400", "19200", "38400", "56000", "57600" }));

        jLabel3.setText("Baud");

        cmbData.setModel(new DefaultComboBoxModel<>(new String[] { "5", "6", "7", "8" }));
        ...
        cmbParity.setModel(new DefaultComboBoxModel<>(new String[] { "none", "odd", "even", "mark", "space" }));

        cmbStop.setModel(new DefaultComboBoxModel<>(new String[] { "1", "1,5", "2" }));
        ...
        cmbHandshake.setModel(new DefaultComboBoxModel<>(new String[] { "Nenhum", "XON/XOFF", "RTS/CTS", "DTR/DSR" }));
